            ...
            public void onClick(View v) {
                ...
                switch (posisi){
                    case 0 :
                        ...
                        break;
                    case 1 :
                        activity.startActivity(new Intent(activity, LokasiSekarang.class).setFlags(Intent.FLAG_ACTIVITY_NEW_TASK));
                        break;
                    case 2 :
                        activity.startActivity(new Intent(activity, LokasiMakanan.class).setFlags(Intent.FLAG_ACTIVITY_NEW_TASK));
                        break;
                    case 3 :
